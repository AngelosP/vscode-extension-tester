...
`packages/controller-extension/package.json`, package-lock metadata, `extension-version-history.json`, and this
file together.

| Version | Date | Kind | Notes |
| ------- | ---- | ---- | ----- |
| 0.3.1 | 2026-08-18 | patch | Harden dirty-editor cleanup and verified tab activation |
| 0.3.0 | 2026-07-10 | minor | Add verified per-channel log-level control and output artifact fallback |
