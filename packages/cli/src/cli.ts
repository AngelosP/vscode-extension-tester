...
program
  ...
  .option('--collect-webview-json <expr>', 'Collect JSON artifact from webview expression after each passing scenario; repeatable', collectRepeated, [])
  .option('--collect-extension-host-json <expr>', 'Collect JSON artifact from extension host expression after each passing scenario; repeatable', collectRepeated, [])
